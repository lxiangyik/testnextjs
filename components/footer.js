    ...
    <div className="relative">
      <Container>
          ...
          <div className="lg:col-span-2">
            <div>
              ...
              <Link href="/" className="flex items-center space-x-2 text-2xl font-medium text-indigo-500 dark:text-gray-100">
                  <Image src="/img/logo.png" alt="N" width="70" height="70" className="w-25" />
                  <span>APACE</span>
              </Link>
            </div>

            <div className="max-w-md mt-4 text-gray-500 dark:text-gray-400">
            APACE MEDI is an Importer, Exporter, Distributor & Trading of Medical Device Company. 
            We supply a complete range of Infusion Therapy Products, 
            Injection Products, Diabetes Cares and Pharmaceutical Product
            </div>
          </div>
        ...
        <div className="my-10 text-sm text-center text-gray-600 dark:text-gray-400">
          ...
          Illustrations from{" "}
          <a
            href="https://github.com/lxiangyik/"
            target="_blank"
            rel="noopener ">
            Kingsley
          </a>
